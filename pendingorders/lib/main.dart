...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: MyPendingOrders(
          numOrders: numOrders, customerOrders: customerOrders, taxPercent: taxPercent),
    );
  }
}
...
class MyPendingOrders extends StatelessWidget {
  ...
  MyPendingOrders({Key key, this.numOrders, this.customerOrders, this.taxPercent})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
